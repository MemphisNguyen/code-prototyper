    ...
    >
        <f7-navbar :title="title" :back-link="!multipleSelect">
            <f7-link
                ...
                slot="nav-right"
            >@{{ multipleSelect ? translate('Cancel') : translate('Select') }}</f7-link>
            <f7-subnavbar>
...
@endif
                ...
                >
                    <f7-swipeout-actions right>
                        <f7-swipeout-button
                            ...
                            :confirm-text="`Do you really want to delete ${value.name}?`"
                        ></f7-swipeout-button>
            ...
            <f7-block class="block-actions">
                <div class="actions" :class="{ 'show': multipleSelect}">
                    <f7-button  fill  raised  round  :color="selectedList.length == 0 ? 'gray' : 'green'">@{{ translate('Active') }}</f7-button>
...
@endif
                                ...
                                <f7-list-item>
                                    ...
                                    >@{{ translate('Clear search result') }}</f7-button>
                                </f7-list-item>
                                <f7-list-item>
